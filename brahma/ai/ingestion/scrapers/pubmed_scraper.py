...
def search_and_scrape(query: str, max_results: int = 10,
                      output_dir: str = "/home/shalu/brahma_workspace/Brahma/brahma/backend/ai/ingestion/output") -> list:
...
def scrape_pubmed_article(pmid: str, output_dir: str = "/home/shalu/brahma_workspace/Brahma/brahma/backend/ai/ingestion/output") -> dict:
