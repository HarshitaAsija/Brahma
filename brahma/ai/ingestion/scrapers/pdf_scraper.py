...
def scrape_pdf(pdf_path: str, output_dir: str = "/home/shalu/brahma_workspace/Brahma/brahma/backend/ai/ingestion/output/pdf") -> Optional[dict]:
    """
    F5 - PDF batch import.
...
def batch_scrape_pdfs(pdf_folder: str, output_dir: str = "/home/shalu/brahma_workspace/Brahma/brahma/backend/ai/ingestion/output/pdf") -> list:
    """
